...
**Sistema multi-agente automatizado para procesamiento de podcasts**

📡 RSS Monitoring → 🎙️ Transcription → 🌍 Translation → 🔊 Text-to-Speech

## 🚀 Inicio Rápido

### 1. Iniciar el Sistema Completo
```bash
./start-globalpodcaster.sh
```
...
### 3. Parar el Sistema
```bash
./stop-globalpodcaster.sh
```

## 📚 Documentación Completa

Ver **[README-USAGE.md](README-USAGE.md)** para:
...
- **4 Agentes MCP**: feed-monitor, transcription, translation, tts
- **Dashboard Web**: Interfaz moderna con controles y estadísticas
- **APIs Integradas**: Deepgram, Mistral, ElevenLabs
- **Automatización**: Pipeline completo sin intervención manual

## ✅ Estado Actual

Sistema **100% funcional** con todas las APIs configuradas y operacionales.
